...
impl Component for SmallHelp {
  ...
  fn draw(&mut self, f: &mut Frame<'_>, area: Rect, state: &State) -> Result<()> {
    ...
    let content = match state.focused_screen {
      FocusedScreen::SearchInput => "Help: <Ctrl-u> | Search: <Enter> | Switch to Replace: <Tab> | Toggle search mode: <Ctrl-n>",
      FocusedScreen::ReplaceInput => "Help: <Ctrl-u> | Replace: <C-o> | Switch to Search List: <Tab> | Toggle replace mode: <Ctrl-n>",
      FocusedScreen::SearchResultList => "Help: <Ctrl-u> | Open File: <Enter> | Switch to Search: <Tab> | Next: <j> | Previous: <k> | Top: <g> | Bottom: <G> | Delete file: <d>",
      FocusedScreen::Preview => "Help: <Ctrl-u> | Back to list: <Enter> | Switch to Search: <Tab> | Next: <j> | Previous: <k> | Top: <g> | Bottom: <G> | Delete line: <d>",
